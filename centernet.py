...
from nets.centernet import CenterNet_HourglassNet, CenterNet_Resnet50, CenterNet_GhostNet
...
class CenterNet(object):
    _defaults = {
        ...
        "classes_path": 'model_data/rice_classes.txt',
        # --------------------------------------------------------------------------#
        #   用于选择所使用的模型的主干
        #   resnet50, hourglass, ghostnet
        # --------------------------------------------------------------------------#
        "backbone": 'resnet50',
        # --------------------------------------------------------------------------#
        #   输入图片的大小，设置成32的倍数
    ...
    def generate(self, onnx=False):
        ...
        #   载入模型与权值
        # -------------------------------#
        assert self.backbone in ['resnet50', 'hourglass', 'ghostnet']
        if self.backbone == "resnet50":
            ...
            self.net = CenterNet_GhostNet(pretrained=True)
